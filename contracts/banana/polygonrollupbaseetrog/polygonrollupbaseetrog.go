...
func (_Polygonrollupbaseetrog *PolygonrollupbaseetrogTransactor) RollbackBatches(opts *bind.TransactOpts, batchToRollback uint64, accInputHashToRollback [32]byte) (*types.Transaction, error) {
	return _Polygonrollupbaseetrog.contract.Transact(opts, "rollbackBatches", batchToRollback, accInputHashToRollback)
}

// RollbackBatches is a paid mutator transaction binding the contract method 0x669adece.
//
// Solidity: function rollbackBatches(uint64 batchToRollback, bytes32 accInputHashToRollback) returns()
func (_Polygonrollupbaseetrog *PolygonrollupbaseetrogSession) RollbackBatches(batchToRollback uint64, accInputHashToRollback [32]byte) (*types.Transaction, error) {
	return _Polygonrollupbaseetrog.Contract.RollbackBatches(&_Polygonrollupbaseetrog.TransactOpts, batchToRollback, accInputHashToRollback)
}

// RollbackBatches is a paid mutator transaction binding the contract method 0x669adece.
//
// Solidity: function rollbackBatches(uint64 batchToRollback, bytes32 accInputHashToRollback) returns()
func (_Polygonrollupbaseetrog *PolygonrollupbaseetrogTransactorSession) RollbackBatches(batchToRollback uint64, accInputHashToRollback [32]byte) (*types.Transaction, error) {
	return _Polygonrollupbaseetrog.Contract.RollbackBatches(&_Polygonrollupbaseetrog.TransactOpts, batchToRollback, accInputHashToRollback)
}
...
func (_Polygonrollupbaseetrog *PolygonrollupbaseetrogFilterer) FilterRollbackBatches(opts *bind.FilterOpts, batchToRollback []uint64) (*PolygonrollupbaseetrogRollbackBatchesIterator, error) {
	...
	logs, sub, err := _Polygonrollupbaseetrog.contract.FilterLogs(opts, "RollbackBatches", batchToRollbackRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event RollbackBatches(uint64 indexed batchToRollback, bytes32 accInputHashToRollback)
func (_Polygonrollupbaseetrog *PolygonrollupbaseetrogFilterer) WatchRollbackBatches(opts *bind.WatchOpts, sink chan<- *PolygonrollupbaseetrogRollbackBatches, batchToRollback []uint64) (event.Subscription, error) {
	...
	logs, sub, err := _Polygonrollupbaseetrog.contract.WatchLogs(opts, "RollbackBatches", batchToRollbackRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
