...
func (_Ibridgel2sovereignchains *Ibridgel2sovereignchainsCaller) GetProxiedTokensManager(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Ibridgel2sovereignchains.contract.Call(opts, &out, "getProxiedTokensManager")
...
//
// Solidity: function getProxiedTokensManager() view returns(address)
func (_Ibridgel2sovereignchains *Ibridgel2sovereignchainsSession) GetProxiedTokensManager() (common.Address, error) {
	return _Ibridgel2sovereignchains.Contract.GetProxiedTokensManager(&_Ibridgel2sovereignchains.CallOpts)
}

// GetProxiedTokensManager is a free data retrieval call binding the contract method 0x38b8fbbb.
//
// Solidity: function getProxiedTokensManager() view returns(address)
func (_Ibridgel2sovereignchains *Ibridgel2sovereignchainsCallerSession) GetProxiedTokensManager() (common.Address, error) {
	return _Ibridgel2sovereignchains.Contract.GetProxiedTokensManager(&_Ibridgel2sovereignchains.CallOpts)
}
...
func (_Ibridgel2sovereignchains *Ibridgel2sovereignchainsCaller) GetWrappedTokenBridgeImplementation(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Ibridgel2sovereignchains.contract.Call(opts, &out, "getWrappedTokenBridgeImplementation")
...
//
// Solidity: function getWrappedTokenBridgeImplementation() view returns(address)
func (_Ibridgel2sovereignchains *Ibridgel2sovereignchainsSession) GetWrappedTokenBridgeImplementation() (common.Address, error) {
	return _Ibridgel2sovereignchains.Contract.GetWrappedTokenBridgeImplementation(&_Ibridgel2sovereignchains.CallOpts)
}

// GetWrappedTokenBridgeImplementation is a free data retrieval call binding the contract method 0x3b2fee9a.
//
// Solidity: function getWrappedTokenBridgeImplementation() view returns(address)
func (_Ibridgel2sovereignchains *Ibridgel2sovereignchainsCallerSession) GetWrappedTokenBridgeImplementation() (common.Address, error) {
	return _Ibridgel2sovereignchains.Contract.GetWrappedTokenBridgeImplementation(&_Ibridgel2sovereignchains.CallOpts)
}
...
func (_Ibridgel2sovereignchains *Ibridgel2sovereignchainsSession) Initialize(_networkID uint32, _gasTokenAddress common.Address, _gasTokenNetwork uint32, _globalExitRootManager common.Address, _polygonRollupManager common.Address, _gasTokenMetadata []byte, _bridgeManager common.Address, sovereignWETHAddress common.Address, _sovereignWETHAddressIsNotMintable bool, _emergencyBridgePauser common.Address, _emergencyBridgeUnpauser common.Address, _proxiedTokensManager common.Address) (*types.Transaction, error) {
	return _Ibridgel2sovereignchains.Contract.Initialize(&_Ibridgel2sovereignchains.TransactOpts, _networkID, _gasTokenAddress, _gasTokenNetwork, _globalExitRootManager, _polygonRollupManager, _gasTokenMetadata, _bridgeManager, sovereignWETHAddress, _sovereignWETHAddressIsNotMintable, _emergencyBridgePauser, _emergencyBridgeUnpauser, _proxiedTokensManager)
}
