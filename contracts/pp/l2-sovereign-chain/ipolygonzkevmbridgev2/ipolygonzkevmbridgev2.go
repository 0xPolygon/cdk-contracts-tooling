...
func (_Ipolygonzkevmbridgev2 *Ipolygonzkevmbridgev2Caller) GetProxiedTokensManager(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Ipolygonzkevmbridgev2.contract.Call(opts, &out, "getProxiedTokensManager")
...
//
// Solidity: function getProxiedTokensManager() view returns(address)
func (_Ipolygonzkevmbridgev2 *Ipolygonzkevmbridgev2Session) GetProxiedTokensManager() (common.Address, error) {
	return _Ipolygonzkevmbridgev2.Contract.GetProxiedTokensManager(&_Ipolygonzkevmbridgev2.CallOpts)
}

// GetProxiedTokensManager is a free data retrieval call binding the contract method 0x38b8fbbb.
//
// Solidity: function getProxiedTokensManager() view returns(address)
func (_Ipolygonzkevmbridgev2 *Ipolygonzkevmbridgev2CallerSession) GetProxiedTokensManager() (common.Address, error) {
	return _Ipolygonzkevmbridgev2.Contract.GetProxiedTokensManager(&_Ipolygonzkevmbridgev2.CallOpts)
}
...
func (_Ipolygonzkevmbridgev2 *Ipolygonzkevmbridgev2Caller) GetWrappedTokenBridgeImplementation(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Ipolygonzkevmbridgev2.contract.Call(opts, &out, "getWrappedTokenBridgeImplementation")
...
//
// Solidity: function getWrappedTokenBridgeImplementation() view returns(address)
func (_Ipolygonzkevmbridgev2 *Ipolygonzkevmbridgev2Session) GetWrappedTokenBridgeImplementation() (common.Address, error) {
	return _Ipolygonzkevmbridgev2.Contract.GetWrappedTokenBridgeImplementation(&_Ipolygonzkevmbridgev2.CallOpts)
}

// GetWrappedTokenBridgeImplementation is a free data retrieval call binding the contract method 0x3b2fee9a.
//
// Solidity: function getWrappedTokenBridgeImplementation() view returns(address)
func (_Ipolygonzkevmbridgev2 *Ipolygonzkevmbridgev2CallerSession) GetWrappedTokenBridgeImplementation() (common.Address, error) {
	return _Ipolygonzkevmbridgev2.Contract.GetWrappedTokenBridgeImplementation(&_Ipolygonzkevmbridgev2.CallOpts)
}
